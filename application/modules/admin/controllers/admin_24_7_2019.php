...
class Admin extends MY_Controller{
	...
	function __construct(){
		...
		public function update_archive_details(){
			...
			$archive_name_edt = $_POST['archive_name_edt'];
			$emp_name = $_POST['emp_name'];
			$date_expiry_edt = $_POST['date_expiry_edt'];
			$archive_id_edt = $_POST['archive_id_edt'];

			$this->admin_m->update_archive_details($archive_name_edt,$emp_name,$date_expiry_edt,$archive_id_edt);
			redirect('/admin#archive_documents_settings');
		}

		public function delete_archive_type($archive_type_id){
			$this->admin_m->delete_archive_details($archive_type_id);
			redirect('/admin#archive_documents_settings');
		}
