...
<!--  Total Hour Rate -->
	...
	<div class="box yellow-border m-bottom-10">
							<div class="box-head yellow-bg pad-5"><label class="yellow-title"><i class="fa fa-cube fa-lg"></i> Total Hour Rate</label></div>
...
<!-- Hour Rate Cost Inc On Costs -->
						...
						<div class="box yellow-border">
							<div class="box-head yellow-bg pad-5">
								<label class="yellow-title"><i class="fa fa-cube fa-lg"></i> Hour Rate Cost Inc On Costs</label>
							</div>
