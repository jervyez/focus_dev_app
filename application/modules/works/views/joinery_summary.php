...
$pdf->Cell(50,10,'Retail(ex GST)',0,0,'R');
...
foreach ($joinery_t->result_array() as $joinery_row){
  ...
  $pdf->Cell(50,10,number_format($joinery_row['j_quote']),0,0,'R');
...
$pdf->Output($filepath.'joinery_summary_w_cost.pdf','F');
$pdf->Output($filepath.'joinery_summary_w_cost.pdf','I');
}
?>