...
foreach ($project_t->result_array() as $row){
	...
	$pdf->Cell(30,10,'Design Quotation and Contract:',0,0);
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(20,10,'',0,0);
	$pdf->cell(70,10,'1.  Schedule of Works Include in Quotation: 	___________________________________________');
	...
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(20,10,'',0,0);
	$pdf->cell(70,10,'2.  Condition of Quotation and Contract: 	      ___________________________________________');
	...
	if($has_sign == 1){
		$pdf->Image('./uploads/misc/garbage_list/'.$project_manager_id.'.png',50,120,50);
	}
	...
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,10,'',0,0);
	$pdf->multicell(155,4,'I/We accept the quotation for the Works and agree to the "Terms of Trade" of Quotation and Contract and acknowledge that all payments are to be made withing fourteen(14) days of receipt of invoice in accordance with the following:-');
	...
	if($focus_comp == "Focus Shopfit Pty Ltd"){
		$pdf->ln(7);
		$pdf->cell(10);
		$pdf->SetFont('Arial','',9);
		$pdf->Cell(20,10,'',0,0);
		...
		$pdf->SetFont('Arial','',9);
		$pdf->Cell(20,10,'',0,0);
		$pdf->cell(65,10,'NAB BSB: 086-334 Account: 15-409-0029');
