					...
					//	else{ // remove else after
						...
						if($userdata->skip_dashboard == 1){ 
							...
							if($this->session->userdata('user_role_id') == 8){
								redirect('/dashboard/estimators', 'refresh'); 
							}else{
...
*/
	...
	//		echo '<p id="" class="">'.$loc_time_zone.'</p>';
	//	}
...
/*
		if($user_ave['aus_timezone'] == 1){
			$aus_timezone = '(AWST)';
		}elseif($user_ave['aus_timezone'] == 2){
			$aus_timezone = '(AEDT)';
		}elseif($user_ave['aus_timezone'] == 3){
				$aus_timezone = '(PHT)';
			}else{
			$aus_timezone = '';
		}
...
//$new_set_date_end = DateTime( 	$user_ave['date_time_stamp_b'] );
...
/*
$d_date = new DateTime(); 
$d_date->setTimestamp($user_ave['date_time_stamp_b']);
$d_date->setTimezone(new DateTimeZone($state_code_loc));
...
/*
			if($reoccur_ave['aus_timezone'] == 1){
				$aus_timezone = '(AWST)';
			}elseif($reoccur_ave['aus_timezone'] == 2){
				$aus_timezone = '(AEDT)';
			}elseif($reoccur_ave['aus_timezone'] == 3){
				$aus_timezone = '(PHT)';
			}else{
				$aus_timezone = '';
			}
...
/*
			...
			if($return_text != ''){
				return $reoccur_ave['notes'].' Return:'.$date_end.' '.$aus_timezone;
			}else{
				echo '<span style="color:#1F3A4D;" class=" tooltip-enabled" title="" data-original-title="'.$reoccur_ave['notes'].' Return:'.$date_end.' '.$aus_timezone.'"><i class="fa fa-info-circle" aria-hidden="true"></i></span>';
			}
*/
