									...
									<?php if( $this->session->get('users') > 1 || $this->session->get('user_id') == $user_id || $this->session->get('is_admin') ==  1  ): ?>
											...
											<?php if($this->session->get('is_admin') ==  1): ?>
												...
												<div class="col-md-6 col-sm-4 col-xs-12 m-bottom-10 clearfix ">
													...
													<div class="col-sm-8">
														<select name="is_dummy" class="form-control is_dummy" id="is_dummy">
															<option value="1" <?php if($user->is_dummy == '1'){ ?> selected <?php } ?>>Yes</option>
															<option value="0" <?php if($user->is_dummy == '0'){ ?> selected <?php } ?>>No</option>
														</select>
													</div>
												</div>
												...
												<div class="col-sm-2" style="padding-left: 20px;">
													...
													?>
														...
														<?php if( $this->session->get('users') > 1 || $this->session->get('is_admin') ==  1  ): ?>
															...
															<div class="form-group m-left-10">
																<label for="leave_rate_type">Leave Rate Type</label>
																<select name="leave_rate_type" class="form-control leave_rate_type" id="leave_rate_type" tabindex="">
																	...
																	<option value="3" <?php if($leave_alloc->leave_rate_type == '3'){ echo 'selected'; } ?>>Manila Staff</option>

																	<?php } else { ?>

																	<option value="1">AU - Salaried</option>
																	<option value="2">AU - Wages</option>
														...
														<?php else: ?>
															...
															<!-- <div class="form-group m-left-10">
																...
																<?php //if (!empty($leave_alloc)){ ?>
																	...
																	<select name="leave_rate_type" class="form-control leave_rate_type" id="leave_rate_type"  tabindex="" disabled="TRUE">
																		<option value="1" <?php //if($leave_alloc->leave_rate_type == '1'){ echo 'selected'; } ?>>AU - Salaried</option>
																		<option value="2" <?php //if($leave_alloc->leave_rate_type == '2'){ echo 'selected'; } ?>>AU - Wages</option>
																		<option value="3" <?php //if($leave_alloc->leave_rate_type == '3'){ echo 'selected'; } ?>>Manila Staff</option>
																	</select>
														...
														<!-- <div class="form-group m-left-10">
														    ...
														    <div class="input-group ">
																...
																<input type="text" id="no_hrs_of_work" class="form-control text-center" name="no_hrs_of_work" value="<?php //echo (!empty($leave_alloc->no_hrs_of_work) ? $leave_alloc->no_hrs_of_work : '' ); ?>">
															</div>
														</div> -->
													...
													<div class="col-sm-5">
														...
														<?php if ($user->is_offshore == 1) {?>
															<label name="annual_day_earned" id="annual_day_earned" class="control-label" style="color: #F7901E; font-weight: bold;"><?php echo (!empty($earned_annual_points) ? round($earned_annual_points, 2).' days' : '0 days' ); ?></label>
														<?php } else { ?>
															<label name="annual_day_earned" id="annual_day_earned" class="control-label" style="color: #F7901E; font-weight: bold;"><?php echo (!empty($leave_alloc->total_annual) ? round($total_annual_points, 6).' days' : '0 days' ); ?></label>
														<?php } ?>
														</div>
														...
														<div class="col-sm-6">
															<label name="used_annual" id="used_annual" class="control-label" style="color: red; font-weight: bold;"><?php echo (!empty($used_annual_total->used_annual) ? number_format($used_annual_total->used_annual - $annual_holidays->holidays, '2', '.', ''). ' days' : '0 days' ); ?></label> 
														</div>
														...
														<div class="col-sm-6">
															<label name="total_annual" id="total_annual" class="control-label" style="color: green; font-weight: bold;"><?php echo (!empty($leave_alloc->total_annual) ? round($leave_alloc->total_annual, 2).' days' : '0 days' ); ?></label>
														</div>
													</div>
													...
													<div class="col-sm-5">
														...
														<div class="col-sm-6">
														<?php if ($user->is_offshore == 1) {?>
															<label name="personal_day_earned" id="personal_day_earned" class="control-label" style="color: #F7901E; font-weight: bold;"><?php echo (!empty($earned_annual_points) ? round($earned_personal_points, 2).' days' : '0 days' ); ?></label>
														<?php } else { ?>
															<label name="personal_day_earned" id="personal_day_earned" class="control-label" style="color: #F7901E; font-weight: bold;"><?php echo (!empty($leave_alloc->total_annual) ? round($total_personal_points, 6).' days' : '0 days' ); ?></label>
														<?php } ?>
														</div>
														...
														<div class="col-sm-6">
																<label name="used_personal" id="used_personal" class="control-label" style="color: red; font-weight: bold;"><?php echo (!empty($used_personal_total->used_personal) ? number_format($used_personal_total->used_personal - $sick_holidays->holidays, '2', '.', ''). ' days' : '0 days' ); ?></label>
														</div>
														...
														<div class="col-sm-6">
															<label name="total_personal" id="total_personal" class="control-label" style="color: green; font-weight: bold;"><?php echo (!empty($leave_alloc->total_personal) ? round($leave_alloc->total_personal, 2).' days' : '0 days' ); ?></label>
														</div>
								...
								<div class="panel-heading" role="tab" id="collapseListGroupHeading1">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse" href="#collapseListGroup2" aria-expanded="false" aria-controls="collapseListGroup2">
											<i class="fa fa-tags fa-lg"></i> <strong class="">Availability</strong> <label> <?php $this->users->get_user_availability($user_id_page); ?> </label>
										</a>
									</h4>
								</div> 
											...
											<?php if($rec_availability->getNumRows() > 0): ?>
												...
												<ul>
													<?php foreach ($rec_availability->getResultArray() as $avail_data): ?>
														...
														<li >
															<span> 
																<strong class="  tooltip-enabled" title="" data-html="true" data-placement="left" data-original-title="<?php echo ucfirst($avail_data['notes']); ?>" id="">
																	<?php echo $avail_data['status']; ?>
																</strong> -
								...
								<div class="panel-heading" role="tab" id="collapseListGroupHeading1">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse" href="#collapseListGroup1" aria-expanded="false" aria-controls="collapseListGroup1">
											<i class="fa fa-unlock fa-lg"></i> <strong class="">Change User Password</strong>
										</a>
									</h4>
								</div>
								<?php if($this->session->get('is_admin') == 1 ): ?>
									...
									<?php else: ?>
										...
										<?php /*	<form method="post" class="change_password_form" onkeypress="return event.keyCode != 13;">
											...
											<form method="post" class="change_password_form" onkeypress="return event.keyCode != 13;">
												...
												<div id="" class="pad-5 border-less-box alert alert-warning m-bottom-10"><p><strong>Note</strong>: Your new password will take effect on your next login.</p></div>
								...
								<div class="panel-heading" role="tab" id="collapseListGroupHeading1">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse" href="#collapseListGroup_pm" aria-expanded="false" aria-controls="collapseListGroup_pm">
											<i class="fa fa-users  fa-lg"></i> <strong class="">Update PM Assignments</strong>
										</a>
									</h4>
								</div>
...
<?php endif; ?>
						...
						<div class="box clearfix">
							<div class="box-head pad-5">
								...
								<i class="fa fa-unlock-alt fa-lg"></i> <strong class="">Select Access</strong></label>
...
<!-- For Site Labour -->
							...
							<div class="col-xs-12 m-bottom-10 clearfix">										 
								<label class="col-sm-4 control-label m-top-5">Sojourn App</label>											 
								<div class="col-sm-8">										
									<div class="site_labour_app">
										<input type="checkbox" class="check-swtich check-a" onchange="myFunction()" id = "sojourn_app" data-checkbox="2" data-label-text="Have Access" <?php echo ($site_labour_app_set == 2 ? 'checked="true"' : ''); ?>>
									</div>
									<input type="hidden" class="" id="site_labour_app" name="site_labour_app" value="<?php echo $site_labour_app_set; ?>">
								</div>
								<script type="text/javascript">
									function myFunction(){
										var x = document.getElementById("sojourn_app").checked;
										if(x == true){
											$("#sojourn_app_access").modal("show");
										}
									}
									...
									function checkall(){
										...
										if(x == true){
								            ...
								            $('#chk_travel_access').prop('checked', true);
								            $("#show_plate_no").show();
										}else{
											$(".checkSingle").each(function() {
								                this.checked=false;
								             ...
								             $('#chk_travel_access').prop('checked', false);
								            $("#show_plate_no").hide();
								            $("#plate_no").val("");
										}
									}
									...
									$(document).ready(function() {
										var travel_access = '<?php echo $travel_access ?>';
										if(travel_access == 1){
											$("#show_plate_no").show();
										}else{
											$("#show_plate_no").hide();
										...
										$("#save_app_access").click(function(){
											...
											if(x == true){
												...
												var opt_sl = document.getElementById("sl").checked;
												if(opt_sl == true){
													sl = "1";
												}
												var opt_pr = document.getElementById("pr").checked;
												if(opt_pr == true){
													pr = "1";
												}
												var opt_ind = document.getElementById("ind").checked;
												if(opt_ind == true){
													ind = "1";
												}
											}
											...
											$.post(baseurl+"users/save_app_access",
									        {
									        	access: access,
									        	user_id: user_id,
									        	sl: sl,
									        ...
									        function(result){
									        	alert("App Access Updated");
									        }); 

									        var has_travel_access = 0;
											var plate_no = "";
											if($("#chk_travel_access"). prop("checked") == true){
												has_travel_access = 1;
									        	plate_no = $("#plate_no").val();
											}

									        $.post(baseurl+"users/save_app_travel_access",
									        {
									        	user_id: user_id,
									        	has_travel_access: has_travel_access,
												plate_no: plate_no
									        },
									        function(result){
									        }); 

									        $("#sojourn_app_access").modal("hide");
										});

										$("#chk_travel_access").click(function(){
											if($("#chk_travel_access"). prop("checked") == true){
												$("#show_plate_no").show();
											}else{
												$("#show_plate_no").hide();
										...
										$("a.view_access_link").click(function(){
											$("#sojourn_app_access").modal("show");
											return false;
										});
									});
								</script>
								<?php if($site_labour_app_set == 2 ): ?>
								<label class="col-sm-4 control-label m-top-5 view_access_link"></label>	
								<div class="col-sm-8"><a href="#" class = "view_access_link">View App Access</a></div>
								<?php endif; ?>
								<!-- Modal -->
								<div class="modal fade" id="sojourn_app_access" role="dialog">
								    <div class="modal-dialog">
								      <!-- Modal content-->
								     	<div class="modal-content">
									        <div class="modal-header">
									          	<button type="button" class="close" data-dismiss="modal">&times;</button>
									          	<h4 class="modal-title">Sojourn App Access</h4>
									        </div>
								       		<div class="modal-body row" style = "padding: 10px">
								       			...
								       			<div class="col-sm-8">
								       				...
								       				?>
								       				<table class="table" style = "border: 1px solid #888">
													    ...
													    <tbody>
													      	<tr>
														        <td>
														        <?php if($sl == 1 || $all_access == 1): ?>
														        	<input type = "checkbox" name = "checkAll" class = "checkSingle" id = "sl" checked="">
														        <?php else: ?>
														        	<input type = "checkbox" name = "checkAll" class = "checkSingle" id = "sl">
														        <?php endif; ?>
														        </td>
										       					<td>Site Labour</td>
													      	</tr>
													     	<tr>
														        <td>
														        <?php if($pr == 1 || $all_access == 1): ?>
														        	<input type = "checkbox" name = "checkAll" class = "checkSingle" id = "pr" checked="">
														        <?php else: ?>
														        	<input type = "checkbox" name = "checkAll" class = "checkSingle" id = "pr">
														        <?php endif; ?>
														        </td>
													      	...
													      	<tr>
														        <td>
														        <?php if($ind == 1 || $all_access == 1): ?>
														        	<input type = "checkbox" name = "checkAll" class = "checkSingle" id = "ind" checked="">
														        <?php else: ?>
														        	<input type = "checkbox" name = "checkAll" class = "checkSingle" id = "ind">
														        <?php endif; ?>
														        </td>
									       						<td>Induction</td>
													      	</tr>
													      	<tr>
													      		<td><input type = "checkbox" name = "chk_travel_access" id = "chk_travel_access" <?php if($travel_access == 1): ?> checked="" <?php endif; ?>></td>
													      		<td>Has Travel Access</td>
													      	</tr>
													      	<tr id = "show_plate_no">
													      		<td colspan = 2>
													      			<label style = "font-size: 10px">Plate No.:</label>
													      			<input type = "text" id = "plate_no" class = "form-control input-sm" placeholder = "Plate No." value = "<?php echo $plate_no ?>">
													      		</td>
													      	</tr>
													    </tbody>
													</table>
								            ...
								            <div class="modal-footer">
								            	<button type = "button" class = "btn btn-success" id = "save_app_access">Save</button>
									        </div>   
								      	</div>
								    </div>
								</div>
...
<?php if ($this->session->get('user_id') == $user_id): ?>
						...
						<div class="panel-group" role="tablist">
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="collapseListGroupHeading1">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse" href="#navListMenu" style="text-decoration: none;" >
											<i class="fa fa-bars fa-lg"></i> <strong class="">Navigation Menu</strong>
										</a>

										<div  style="margin: -7px -11px 0 0;" class="btn-sm pull-right btn btn-success save_menu_arrange">Save</div>
									</h4>
								</div>

								<div id="navListMenu" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading1" aria-expanded="false" style="height: 0px;">
									
									<div class="pad-10 clearfix pad-bottom-0 menu_change_positions">
						...
						<div class="menu_storage_area hide">
							<?php /*
							<div class="menu_list_option input-group  m-bottom-10" id="menu_company">
								<span class="input-group-addon text-left " style="width: 100%;">Company</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_company')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_company')" >&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_projects">
								<span class="input-group-addon text-left " style="width: 100%;">Projects</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_projects')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_projects')" >&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_purchase">
								<span class="input-group-addon text-left " style="width: 100%;">Purchase Order</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_purchase')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_purchase')" >&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_invoice">
								<span class="input-group-addon text-left " style="width: 100%;">Invoice</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_invoice')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_invoice')" >&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_schedule">
								<span class="input-group-addon text-left " style="width: 100%;">Schedule</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_schedule')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_schedule')" >&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_contact">
								<span class="input-group-addon text-left " style="width: 100%;">Contact</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_contact')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_contact')" >&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_site">
								<span class="input-group-addon text-left " style="width: 100%;">Site Labour</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_site')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_site')" >&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_induction">
								<span class="input-group-addon text-left " style="width: 100%;">Induction Health Safety</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_induction')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_induction')">&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_incident">
								<span class="input-group-addon text-left " style="width: 100%;">Incident Report</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_incident')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_incident')">&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_availability">
								<span class="input-group-addon text-left " style="width: 100%;">Availability</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_availability')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_availability')">&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_users">
								<span class="input-group-addon text-left " style="width: 100%;">Users</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_users')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_users')">&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_file">
								<span class="input-group-addon text-left " style="width: 100%;">File Storage</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_file')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_file')">&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_client">
								<span class="input-group-addon text-left " style="width: 100%;">Client Supply</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_client')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_client')">&#8681;</div></span>
							</div>

							<div class="menu_list_option input-group  m-bottom-10" id="menu_help">
								<span class="input-group-addon text-left " style="width: 100%;">Help Videos</span> 
								<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up('menu_help')">&#8679;</div><div class="btn btn-primary move_down_menu" onclick="move_menu_down('menu_help')">&#8681;</div></span>
							</div>
						...
						<style>
							.menu_change_positions .menu_list_option:nth-of-type(1) .move_up_menu{display: none;} 
							.menu_change_positions .menu_list_option:last-child  .move_down_menu{display: none;} 
							.menu_change_positions .menu_list_option .input-group-addon.active{ background-color: #fff5a2;}
							.menu_change_positions .menu_list_option .input-group-addon{ font-size: 11px; }
						</style>

						<?php $ordered_menu = explode(',',$user->left_nav_order); //  var_dump($user->left_nav_order);    ?>
...
setTimeout(function(){
							$( ".menu_links_container li.nav_menu_link" ).each(function() {
								var left_nav_item = $(this).attr('id');
								var nav_item_array = left_nav_item.split('_');
								var menu_text = $(this).find('label.control-label').text();

							//	alert(nav_item_array[2]);



								var elem_menu_html = '<div class="menu_list_option input-group input-group-sm m-bottom-10" id="menu_'+nav_item_array[2]+'">'+
								'<span class="input-group-addon text-left " style="width: 100%;">'+menu_text+'</span>'+
								'<span class="input-group-btn"><div class="btn btn-info move_up_menu" onclick="move_menu_up(\'menu_'+nav_item_array[2]+'\')">&#8679;</div>'+
								'<div class="btn btn-primary move_down_menu" onclick="move_menu_down(\'menu_'+nav_item_array[2]+'\')">&#8681;</div></span></div>';




								$('.menu_storage_area').append(elem_menu_html );
							...
							setTimeout(function(){
								...
								<?php if($user->left_nav_order == ''): ?>
									var menu_link = $('.menu_storage_area').html();
									$('.menu_change_positions').html(menu_link );

								<?php else: ?>

									<?php foreach ($ordered_menu as $key => $value): ?>
									var menu_link = $('#<?php echo $value;  ?>').clone();
									$('.menu_change_positions').append(menu_link );
								<?php endforeach; ?>
...
function move_menu_up(elm_id){

	$('.menu_list_option .input-group-addon ').removeClass('active');

 	var menu_link = elm_id;
	var menu_prev = $('#'+elm_id).prev().attr('id');





	$('#'+menu_link+' .input-group-addon').addClass('active');




	var tdiv1 = $('#'+menu_link).clone();
	var tdiv2 = $('#'+menu_prev).clone();


 	$('#'+menu_link).replaceWith(tdiv2);
    $('#'+menu_prev).replaceWith(tdiv1);

}

function move_menu_down(elm_id){
	$('.menu_list_option .input-group-addon ').removeClass('active');
 
 	var menu_link = elm_id;
	var menu_next = $('#'+elm_id).next().attr('id');	 

	$('#'+menu_link+' .input-group-addon').addClass('active');
	
	var rdiv1 = $('#'+menu_link).clone();
	var rdiv2 = $('#'+menu_next).clone();
 
	$('#'+menu_next).replaceWith(rdiv1);
	$('#'+menu_link).replaceWith(rdiv2);
}

 

$('.save_menu_arrange').click(function(){

	var save_menu_arrangement = '';
	$( ".menu_change_positions .menu_list_option" ).each(function() {
		// alert( $(this).attr('id') );
		save_menu_arrangement += ','+$(this).attr('id');
	});

	save_menu_arrangement = save_menu_arrangement.substring(1);
	//alert(save_menu_arrangement);
	$('input#menu_list_order').val(save_menu_arrangement);

	$('#loading_modal').modal({"backdrop": "static", "show" : true} );

	setTimeout(function(){
		$( "#menu_list_form" ).submit();
	},1000);
        ...
        <div class="tab-content">
          ...
          <div id="help_videos" class="tab-pane fade clearfix active in">
            <div id="" class="m-10 p-bottom-10 clearfix">
              <?php $cat_keyword = 'users'; $sub_cat_keyword = 'account'; ?>
            	<p id="" class="m-left-5 p-bottom-10 m-top-5 clearfix" style="font-weight: bold;    font-size: 16px;    border-bottom: 1px solid #ccc;">User Account Screen Videos</p>
