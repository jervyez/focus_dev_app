...
<?php $focus_id_main_display = $this->session->get('set_view_company_project'); ?>
<?php 

  $progress_reports = $this->session->get('progress_report');
  $get_table_status = $this->request->getGet('status');
  $custom_q = '';
...
*/
  ...
  foreach ($user_query->getResultArray() as $row){
    $user_id = $row['user_id'];
  ...
  if($user_id == $focus_user_id  || $focus_user_id == 6){
    $send_email = $this->session->get('auto_send_email'); 
  ...
  <div class="modal-dialog  modal-sm">
    <div class="modal-content" style = "width:400px" id = "brand_app">
      ...
      <div class="modal-body" style = "height: 300px">
        <form action="<?php echo site_url(); ?>induction_health_safety/upload_brand_logo" method="post" enctype="multipart/form-data">
...
<div class="container-fluid head-control">
	<div class="container-fluid">
		<div class="row">
          ...
          <li>
            <a href="<?php echo site_url(); ?>site_login"><i class="fa fa-map-marker"></i> Site Login</a>
          </li>   
          <?php endif; ?> 

          <?php if($this->session->get('is_admin') == 1 || $this->session->get('user_role_id') == 2 || $this->session->get('user_role_id') == 3 || $this->session->get('user_role_id') == 4  || $this->session->get('user_id') == 9 || $this->session->get('user_role_id') == 20): ?>
          <li>
            <a href="<?php echo site_url(); ?>induction_health_safety/inductions_projects"> Induction</a>
          </li> 
          <?php endif; ?>  
  ...
  <?php endif; ?>
          ...
          <?php if($this->session->get('user_role_id') == 3 ||$this->session->get('user_role_id') == 20 || $this->session->get('user_role_id') == 2 || $this->session->get('user_role_id') == 7   || $this->session->get('user_role_id') == 16  || $this->session->get('is_admin') == 1 || $this->session->get('user_id') == 6 ): ?>
             <li>
              <a href="<?php echo site_url(); ?>projects/projects_wip_review" class="btn-small btn-primary" ><i class="fa fa-file-text-o"></i> WIP Review</a>
            </li>
          <?php endif; ?>
         
          <?php if($this->session->get('quick_quote') == 1): ?>
          <li class="">
            <a href="<?php echo site_url(); ?>quick_quotes" class="btn-small btn-primary" > Quick Quotes</a>
          </li>  
          <?php endif; ?>
         ...
         <?php if($this->session->get('is_admin') == 1 || $this->session->get('user_id') == 6  ||  ( $this->session->get('projects') >= 1 && $this->session->get('user_role_id') == 2   )       ): ?>
          <li class="">
          ...
          <?php endif; ?>
           ...
           <li class="">
            <a href="<?php echo site_url(); ?>projects/document_storage" class="btn-small btn-primary"><em class="fa fa-cloud-upload"></em> Doc Storage</a>
          </li> 
...
<?php if(   $this->session->get('projects') >= 1 && $this->session->get('user_role_id') == 2        ): ?>
  <script type="text/javascript">
    /* FOR PA ONLY*/
    setTimeout(function(){  
		...
		<div class="section col-sm-12 col-md-11 col-lg-11">
			<div class="container-fluid">
				...
				<div class="row">
                 ...
                 <?php elseif($this->session->get('company_project') == 1): ?>
                ...
                <?php endif; ?>
                  ...
                  <?php if($this->session->get('user_role_id') == 3 ||$this->session->get('user_role_id') == 16 ||$this->session->get('user_role_id') == 20 || $this->session->get('user_role_id') == 2 || $this->session->get('user_role_id') == 8 || $this->session->get('user_role_id') == 7 || $this->session->get('company_project') == 1 ): ?>
                    ...
                    <select class="form-control m-top-10 select-personal right"  style="float: right; width: 120px; margin-right: 5px;">
                      ...
                      <?php if($this->session->get('user_role_id') == 3 ){
                          echo '<option value="PM">Personal</option>';
                        }elseif($this->session->get('user_role_id') == 20 ){
                          echo '<option value="PM">Personal</option>';
                        }elseif($this->session->get('user_role_id') == 16 ){
                          echo '<option value="PM">Personal</option>';
                        }elseif($this->session->get('user_role_id') == 2 || $this->session->get('user_role_id') == 7 ){
                          echo '<option value="PA">Personal</option>';
                        }elseif($this->session->get('user_role_id') == 8){
                          echo '<option value="EST">Personal</option>';
                        }elseif($this->session->get('company_project') == 1 ){
                          echo '<option value="PM">Personal</option>';
                        }else{ }
                      ?>
                    ...
                    <script type="text/javascript">
                     ...
                     <?php if($this->session->get('default_projects_view_personal') == 1 ) : ?>
...
<?php $project_status_view = $this->session->get('default_projects_landing'); ?>

<script type="text/javascript">

  var proj_stat_display = <?php echo $project_status_view ?? 0; ?>;
 ...
 -->
                  ...
                  if(isset($get_table_status ) && $get_table_status != ''){
                   // echo '<script type="text/javascript">$("select.select_table_status").val("'.$get_table_status.'"); </script>';
                    ...
                    $project_status_view = $this->session->get('default_projects_landing');
...
<span class="fa fa-film pointer open_help_vids_mpd" data-toggle="modal" data-target="#help_video_group"> </span>
            ...
            <div class="box">
              <div class="box-head pad-5">
                ...
                <strong class="quotes">Quotes</strong></label> &nbsp; &nbsp;
					...
					<?php //if($this->session->get('user_id') == 48):
        ...
        <?php endif; ?>
          ...
          <?php if($this->session->get('is_admin') == 1 || $this->session->get('user_id') == 9): ?>
            ...
            <div class="box">
              <div class="box-head pad-5">
                ...
                <div class="input-group pull-right" style="width:160px;">
                 ...
                 <a href="<?php site_url(); ?>projects/read_csv_logs" target="_blank" class="btn input-group-addon btn-success hide tooltip-enabled" title="" data-html="true" data-placement="top" data-original-title="Print CSV Report" style="color:#fff;"><i class="fa fa-print" aria-hidden="true"></i></a>  
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class="input-group m-bottom-10">
            ...
            <?php
              foreach ($clients_list->getResultArray() as $row){
         ...
         $project_manager = $project_manager_q->getResult();     foreach ($project_manager as $row){    
