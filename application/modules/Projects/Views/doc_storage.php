      ...
      <div class="page-nav-options col-md-6 col-sm-8 col-xs-12 pull-right hidden-xs">
        <ul class="nav nav-tabs navbar-right">
          ...
          <li <?php if($screen=='Supplier'){ echo 'class="active"';} ?> >
            <a href="<?php echo site_url(); ?>projects/client_file_storage" class="btn-small"><em class="fa fa-cloud-upload"></em> Client File Storage</a>        
          </li>
              ...
              <div class="box-head clearfix pad-bottom-10">
                ...
                <div class="input-group pull-right search-work-desc  m-right-5 m-top-15">
                  <div class="input-group">
                    ...
                    <span class="input-group-addon btn search_files_btn btn-primary" style="color:#fff;" data-toggle="modal"  data-backdrop="static" data-target="#loading_modal" ><i class="fa fa-search"></i> Search</span>                  
                  </div>
                </div>
                ...
                <div id="" class="pad-top-5">
                  ...
                  <table id="table" class="table table-striped table-bordered   no-m" cellspacing="0" width="100%">
                     ...
                     <tr>
                        ...
                        <th width="80%" style="border: none;">Project</th>
                        <th width="20%" style="border: none; text-align:right;">
                    <!-- 
                         <div id="" class="btn btn-xs btn-info toggle_download_links"  data-toggle="modal" data-backdrop="static" data-target="#loading_modal" onClick="toggleFileDownload()"  >Select File To Download</div>
                          -->
...
.uploaded_files_row:hover{  background-color: #efefef; }
                ...
                <script type="text/javascript">
                  $('.prj_files_head').click(function(){
                    ...
                    setTimeout(function(){
                     $('.cat_head_row.'+group_id+'_files').show();
                   }, 100);

                  });


                  $('.cat_head_row').click(function(){
                    var head_id = $(this).attr('id');
                    var head_id_arr = head_id.split('_');
                    var prjId = head_id_arr[3];
                    var decCatID = head_id_arr[1];

                    $('.data_files_row').hide();

                    setTimeout(function(){
                     $('.'+prjId+'_prJCat_'+decCatID).show();
                    }, 100);
                  });
...
$('.search_files_up').bind('keyup paste', function(){
...
$('.search_files_up').keyup(function() {
  ...
  var filterd_val = search_val.replace(/[^0-9]/g, '');
  $(this).val(filterd_val);
});


/*
$('.search_files_up').blur(function() {
...
//  $('#loading_modal').modal({"backdrop": "static", "show" : true} );
  ...
  $('.prj_files_head#'+search_files_up).parent().show();
  $('.data_files_row').hide();
});
                  ...
                  $('select#year_prj_cdt').on("change", function(e) {
                    ...
                    setTimeout(function(){
                      window.location.replace('<?php echo site_url(); ?>projects/document_storage/'+data);
                    },1000);
                  });
