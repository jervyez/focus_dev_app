...
<div id="job_book_area" style="display:none">
	...
	<div class="full clearfix mgn-10">
		...
		<div class="one-fourth"><p><?php echo ( isset($contact_person_phone_mobile) ) ? 'Mobile No: <strong>'.$contact_person_phone_mobile.'</strong>' : ""; ?></p></div>
		<div class="one-fourth"><p><?php echo ( isset($contact_person_phone_direct) ) ? 'Direct No: <strong>'.$contact_person_phone_direct.'</strong>' : ""; ?></p></div>
	</div>
