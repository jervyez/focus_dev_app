						...
						<div class="col-md-9">
							...
							<?php endif; ?>						
									...
									<div class="box-head pad-top-15 pad-left-15 pad-bottom-10 clearfix">
										...
										<a id="delete_focus" href="<?php echo base_url(); ?>/admin/delete_company/<?php echo $company_id; ?>" class="btn btn-danger btn-md pull-left m-right-10 " style="display:none"><i class="fa fa-trash-o"></i> Delete Company</a>	
