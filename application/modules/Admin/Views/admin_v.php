...
<?php 
	...
	use App\Modules\Site_labour\Controllers\Site_labour;
	$this->site_labour = new Site_labour();
...
<style type="text/css">
	.offset_on_sm2mid{
		width: 23%; position: fixed; right:0; top: 106px; z-index: 10;
	}
...
<script type="text/javascript">
	...
	$(window).scroll(function() {
		...
		if(scrolled_val == 0){
			$(".offset_on_sm2mid ").css('top','106px');
						...
						<div class="left-section-box  col-sm-12 col-md-12 col-lg-9 m-top-10">
							...
							<div class="box-area pad-10 border-top">
								...
								<?php if(@$this->session->getFlashdata('update_matrix')): ?>
									<div class="no-pad-t m-bottom-10">
										<div class="border-less-box alert alert-success fade in pad-5">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								...
								<form class="form-horizontal cost_matrix"  role="form" method="post" action="<?php echo base_url(); ?>/matrix">
									<div  class=" box yellow-border m-top-0 warranty_defaults" >
										...
										<div class="box-area pad-5 clearfix">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('total_days') ?? 'has-error';  ?>"> 
												<label for="total_days" class="col-sm-4 control-label">Total Days</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="1" required class="form-control" id="total_days" name="total_days" placeholder="Total Days" value="<?= $_POST['total_days'] ?? $total_days; ?>">
												</div>
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('rate') ?? 'has-error';  ?>">
												<label for="rate" class="col-sm-4 control-label">Hour Rate</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon" id="">$</span>
														<input type="number" step="any" min="0" required class="form-control" id="rate" name="rate" placeholder="Rate ($)" value="<?= $_POST['rate'] ?? $rate; ?>">
													</div>
												</div>
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('hours') ?? 'has-error';  ?>">
												<label for="hours" class="col-sm-4 control-label">Total Hours</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="1" required class="form-control" id="hours" name="hours" placeholder="Hours" value="<?= $_POST['hours'] ?? $hours; ?>">
												</div>
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('superannuation') ?? 'has-error';  ?>">
												<label for="superannuation" class="col-sm-4 control-label">Superannuation</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon" id="">%</span>
														<input type="number" step="any" min="0" required class="form-control" id="superannuation1" name="superannuation" placeholder="Superannuation" value="<?= $_POST['superannuation'] ?? $superannuation; ?>">
													</div>
												</div>
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('workers-comp') ?? 'has-error';  ?>">
												<label for="workers-comp" class="col-sm-4 control-label">Workers Comp</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon" id="">%</span>
														<input type="number" step="any" min="0" required class="form-control" id="workers-comp" name="workers-comp" placeholder="Workers Comp" value="<?= $_POST['workers-comp'] ?? $worker_compensation; ?>">
													</div>
												</div>
											</div>

											<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('public-holidays') ?? 'has-error has-feedback';  ?>">
												<label for="public-holidays" class="col-sm-4 control-label">Public Holidays</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="1" required class="form-control" id="public-holidays" name="public-holidays" placeholder="Public Holidays" value="<?= $_POST['public-holidays'] ?? $public_holidays; ?>">
												</div>
											</div>

											<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('rdos') ?? 'has-error has-feedback';  ?>">
												<label for="rdos" class="col-sm-4 control-label">RDO's</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="1" required class="form-control" id="rdos" name="rdos" placeholder="RDO's" value="<?= $_POST['rdos'] ?? $rdos; ?>">
												</div>
											</div>

											<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sick-leave') ?? 'has-error has-feedback';  ?>">
												<label for="sick-leave" class="col-sm-4 control-label">Sick Leave</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="1" required class="form-control" id="sick-leave" name="sick-leave" placeholder="Sick Leave" value="<?= $_POST['sick-leave'] ?? $sick_leave; ?>">
												</div>
											</div>

											<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('carers-leave') ?? 'has-error has-feedback';  ?>">
												<label for="carers-leave" class="col-sm-4 control-label">Carers Leave</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="1" required class="form-control" id="carers-leave" name="carers-leave" placeholder="Carers Leave" value="<?= $_POST['carers-leave'] ?? $carers_leave; ?>">
												</div>
											</div>

											<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('annual-leave') ?? 'has-error has-feedback';  ?>">
												<label for="annual-leave" class="col-sm-4 control-label">Annual Leave</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="1" required class="form-control" id="annual-leave" name="annual-leave" placeholder="Annual Leave" value="<?= $_POST['annual-leave'] ?? $annual_leave; ?>">
												</div>
											</div>

											<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('downtime') ?? 'has-error has-feedback';  ?>">
												<label for="downtime" class="col-sm-4 control-label">Downtime</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon" id="">%</span>
														<input type="number" step="any" min="0" required class="form-control" id="downtime" name="downtime" placeholder="Downtime" value="<?= $_POST['downtime'] ?? $down_time; ?>">
													</div>
												</div>
											</div>

											<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('leave-loading') ?? 'has-error';  ?>">
												<label for="leave-loading" class="col-sm-4 control-label">Leave Loading</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon" id="">%</span>
														<input type="number" step="any" min="0" required class="form-control" id="leave-loading" name="leave-loading" placeholder="Leave Loading" value="<?= $_POST['leave-loading'] ?? $sc_leave_loading; ?>">
													</div>
												</div>
											</div>
...
<p><hr /></p>
								...
								<?php if(@$this->session->getFlashdata('update_labour_cost_matrix')): ?>
									<div class="no-pad-t m-bottom-10">
										<div class="border-less-box alert alert-success fade in pad-5">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>											
											<?php echo $this->session->getflashdata('update_labour_cost_matrix');?>
										</div>
									</div>
								<?php endif; ?>
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('superannuation') ?? 'has-error';  ?> ">
												...
												<div class="col-sm-8">
													<div class="input-group">
														...
														<input type="number" step="any" min="0" required class="form-control" placeholder="Superannuation (%)" id="superannuation" name="superannuation" value="<?= $_POST['superannuation'] ?? $superannuation; ?>">
													</div>
												</div>	
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('workers_compensation') ?? 'has-error';  ?>">
												<label for="workers_compensation" class="col-sm-4 control-label">Workers Compensation</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon">%</span>
														<input type="number" step="any" min="0" required class="form-control" placeholder="Workers Compensation (%)" id="workers_compensation" name="workers_compensation" value="<?= $_POST['workers_compensation'] ?? $workers_compensation; ?>">
													</div>
												</div>	
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('payroll_tax') ?? 'has-error';  ?>">
												<label for="payroll_tax" class="col-sm-4 control-label">Payroll Tax</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon">%</span>
														<input type="number" step="any" min="0" required class="form-control" placeholder="Payroll Tax (%)" id="payroll_tax" name="payroll_tax" value="<?= $_POST['payroll_tax'] ?? $payroll_tax; ?>">
													</div>
												</div>	
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('leave_loading') ?? 'has-error';  ?>">
												...
												<div class="col-sm-8">
													<div class="input-group">
														...
														<input type="number" step="any" min="0" required class="form-control" placeholder="Leave Loading (%)" id="leave_loading" name="leave_loading" value="<?= $_POST['leave_loading'] ?? $lc_leave_loading; ?>">
													</div>
												</div>	
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('other') ?? 'has-error';  ?> ">
												<label for="other" class="col-sm-4 control-label">Other</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon">%</span>
														<input type="number" step="any" min="0" required class="form-control" placeholder="Other (%)" id="other" name="other" value="<?= $_POST['other'] ?? $other; ?>">
													</div>
												</div>	
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('total_leave_days') ?? 'has-error';  ?> ">
												<label for="total_leave_days" class="col-sm-4 control-label">Total Leave Days</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="0" required class="form-control" placeholder="Total Leave Days" id="total_leave_days" name="total_leave_days" value="<?= $_POST['total_leave_days'] ?? $total_leave_days; ?>">
													
												</div>	
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('total_work_days') ?? 'has-error';  ?>">
												<label for="total_work_days" class="col-sm-4 control-label">Total Work Days</label>
												<div class="col-sm-8">
													<input type="number" step="any" min="0" required class="form-control" placeholder="Total Work Days" id="total_work_days" name="total_work_days" value="<?= $_POST['total_work_days'] ?? $total_work_days; ?>">
...
<!-- Category Mark-Up -->		
								...
								<?php if(@$this->session->getFlashdata('update_prj_mrk')): ?>
									<div class=" m-top-15 m-bottom-10" id="form_category_mark_up"><p class=""><br /></p><p class=""><br /></p></div>
									<div class="no-pad-t m-bottom-15">
										<div class="border-less-box alert alert-success fade in pad-5">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
											<?php echo $this->session->getFlashdata('update_prj_mrk');?>
										</div>
									</div>
								<?php endif; ?>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Default" id="design_works" name="design_works" value="<?= $_POST['design_works'] ?? $design_works; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Min" id="min_design_works" name="min_design_works" value="<?= $_POST['min_design_works'] ?? $min_design_works; ?>">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Default" id="kiosk" name="kiosk" value="<?= $_POST['kiosk'] ?? $kiosk; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Min" id="min_kiosk" name="min_kiosk" value="<?= $_POST['min_kiosk'] ?? $min_kiosk; ?>">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Default" id="full-fitout" name="full-fitout" value="<?= $_POST['full-fitout'] ?? $full_fitout; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Min" id="min_full_fitout" name="min_full_fitout" value="<?= $_POST['min_full_fitout'] ?? $min_full_fitout; ?>">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Default" id="refurbishment" name="refurbishment" value="<?= $_POST['refurbishment'] ?? $refurbishment; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Min" id="min_refurbishment" name="min_refurbishment" value="<?= $_POST['min_refurbishment'] ?? $min_refurbishment; ?>">
												</div>
											</div>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Default" id="stripout" name="stripout" value="<?= $_POST['stripout'] ?? $stripout; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Min" id="min_stripout" name="min_stripout" value="<?= $_POST['min_stripout'] ?? $min_stripout; ?>">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Default" id="maintenance" name="maintenance" value="<?= $_POST['maintenance'] ?? $maintenance; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Min" id="min_maintenance" name="min_maintenance" value="<?= $_POST['min_maintenance'] ?? $min_maintenance; ?>">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Default" id="minor-works" name="minor-works" value="<?= $_POST['minor-works'] ?? $minor_works; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="number" step="any" min="0" required class="form-control" placeholder="Min" id="min_minor_works" name="min_minor_works" value="<?= $_POST['min_minor_works'] ?? $min_minor_works; ?>">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="text" class="form-control" placeholder="Default" id="joinery-only" name="joinery-only" value="<?= $_POST['joinery-only'] ?? $joinery_only; ?>">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													...
													<input type="text" class="form-control" placeholder="Min" id="min_joinery_only" name="min_joinery_only" value="<?= $_POST['min_joinery_only'] ?? $min_joinery_only; ?>">
												</div>
											</div>
										</div>
...
<!-- Defaults Labour Split -->
								...
								<?php if(@$this->session->getFlashdata('update_default')): ?>
									<div class="no-pad-t">
										<div class=" m-top-15 m-bottom-10" id="form_def_labour_split"><p class=""><br /></p><p class=""><br /></p></div>
										<div class="border-less-box alert alert-success fade in pad-5 m-bottom-15">
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								...
								<form class="form-horizontal defaults_labour_split" role="form" method="post" action="<?php echo current_url(); ?>/defaults">
									...
									<div class="box yellow-border m-top-0">
										...
										<div class="box-area pad-5 clearfix">
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('time-half') ?? 'has-error';  ?>">
												<label for="time-half" class="col-sm-4 control-label">Time &amp; Half Labour</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon">%</span>
														<input type="number" step="any" min="0" required class="form-control" placeholder="Time &amp; Half (%)" id="time-half1" name="time-half" value="<?= $_POST['time-half'] ?? $labor_split_time_and_half; ?>">
													</div>
												</div>
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('double-time') ?? 'has-error';  ?>">
												<label for="double-time" class="col-sm-4 control-label">Double Time</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon">%</span>
														<input type="number" step="any" min="0" required class="form-control" id="double-time" name="double-time" placeholder="Double Time (%)"  value="<?= $_POST['double-time'] ?? $labor_split_double_time; ?>">
													</div>
												</div>
											</div>
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('standard-labour') ?? 'has-error';  ?>">
												<label for="standard-labour" class="col-sm-4 control-label">Standard Labour</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon standard-labour text-left" style="padding: 9px;">% <?= $_POST['standard-labour'] ?? $labor_split_standard; ?></span>
														<input type="hidden" class="form-control" id="standard-labour" readonly="readonly" name="standard-labour" placeholder="Standard Labour (%)"  value="<?= $_POST['standard-labour'] ?? $labor_split_standard; ?>">
														<span class="input-group-addon" style="padding: 9px;"></span>
													</div>
												</div>
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('installation-labour') ?? 'has-error';  ?>">
												...
												<div class="col-sm-8">
													<div class="input-group">
														...
														<input type="number" step="any" min="0" required class="form-control" id="installation-labour" name="installation-labour" placeholder="Installation Labour (%)"  value="<?= $_POST['installation-labour'] ?? $installation_labour_mark_up; ?>">
													</div>
												</div>
											</div>

											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('gst-rate') ?? 'has-error';  ?>">
												<label for="gst-rate" class="col-sm-4 control-label">GST Rate</label>
												<div class="col-sm-8">
													<div class="input-group">
														<span class="input-group-addon">%</span>
														<input type="number" step="any" min="0" required class="form-control" id="gst-rate" name="gst-rate" placeholder="GST Rate (%)"  value="<?= $_POST['gst-rate'] ?? $gst_rate; ?>">
													</div>
												</div>
											</div>
						...
						<div class="box yellow-border total_hour_rate ">
							...
							<div class="box-area clearfix pad-5 m-top-10">
								<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix">
									<label for="" class="col-sm-4  control-label m-top-5 text-right" style="font-weight: normal;">Total Hour </label>
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
								...
								<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix">
									<label for="" class="col-sm-4  control-label m-top-5 text-right" style="font-weight: normal;">Time Half </label>
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
								...
								<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix">
									<label for="" class="col-sm-4  control-label m-top-5 text-right" style="font-weight: normal;">Double Time </label>
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
								...
								<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix">
									<label for="" class="col-sm-4  control-label m-top-5 text-right" style="font-weight: normal;">Amalgamated Rate </label>
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
							...
							<div class="box-area clearfix pad-5 m-top-10">								
								...
								<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix ">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
											<input type="text" class="form-control" readonly="readonly" id="total-hour" name="total-hour" placeholder="Total Hour"  value="<?= $_POST['total-hour'] ?? $total_hour; ?> ">
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
											<input type="text" class="form-control" readonly="readonly" id="time-half" name="time-half" placeholder="Total Time Half" value="<?= $_POST['time-half'] ?? $total_time_half; ?> ">
										</div>
								...
								<div class="col-lg-6 col-md-6  col-sm-6 col-xs-12 m-bottom-10 clearfix ">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
											<input type="text" class="form-control" readonly="readonly" id="double-time1" name="double-time" placeholder="Total Double Time" value="<?= $_POST['double-time'] ?? $total_double_time; ?> ">
										</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<span class="input-group-addon" id="">$</span>
											<input type="text" class="form-control" readonly="readonly" id="amalgamated-rate" name="amalgamated-rate" placeholder="Amalgamated Rate" value="<?= $_POST['amalgamated-rate'] ?? $total_amalgamated_rate; ?> ">
										</div>
								...
								<div>
									...
									<div class="box blue-border m-top-15">
										...
										<div class="box-area clearfix pad-10">
											...
											<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/warranty_categories">
												...
												<div class="box yellow-border m-top-0 warranty_defaults">
													...
													<div class="box-area   clearfix">
														...
														<div class="">
															<div class="col-md-12 col-sm-12 col-xs-12   m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('warranty_setup') ?? 'has-error';  ?>">
											...
											<?php if(@$this->session->getFlashdata('warranty_setup')): ?>
												<div class="col-sm-12 ">							
													<div class="no-pad-t m-left-5 m-right-5">
														<div class=" m-top-15 m-bottom-10" id="form_warranty_extension"><p class=""><br /></p><p class=""><br /></p></div>
														<div class="border-less-box alert alert-success fade in m-top-5 pad-5 m-bottom-15">
															<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
															<?php echo $this->session->getFlashdata('warranty_setup'); ?>
														</div>
													</div>
												</div>
											<?php endif; ?>
											...
											<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/warranty_setup">
												...
												<div class="pad-left-10 pad-right-10 col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('warranty_years') ?? 'has-error';  ?>">
													...
													<div class="input-group">
														...
														<input type="number" step="any" min="0" required placeholder="1" class="form-control" id="warranty_years" name="warranty_years" value="<?php echo $warranty_years ?>">
												...
												<div class="pad-left-10 pad-right-10 col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('warranty_months') ?? 'has-error';  ?>">
													...
													<div class="input-group">
														...
														<input type="number" step="any" min="0" required placeholder="2" class="form-control" id="warranty_months" name="warranty_months" value="<?php echo $warranty_months ?>">
											...
											<form class="form-horizontal unaccepted_project_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_unaccepted_projects">
												...
												<div class="box yellow-border">
													...
													<div class="box-area pad-5 clearfix">
														...
														<div class="">
															<div class="clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('time-half') ?? 'has-error';  ?>">
														...
														<div>
															...
															<div class="pad-left-10 pad-right-10 col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
																<div class="input-group">
																	...
																	<input type = "text" class="form-control" id="unaccepted_num_days" name="unaccepted_num_days" value="<?= $_POST['unaccepted_num_days'] ?? $unaccepted_no_days; ?>">
																</div>
															</div>
															...
															<div class="pad-left-10 pad-right-10 col-lg-6 col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
																<div class="input-group">
																	...
																	<input type="text" placeholder="Days Quote Deadline" class="form-control" id="days_quote_deadline" name="days_quote_deadline" value = "<?= $_POST['days_quote_deadline'] ?? $days_quote_deadline; ?>">
										    ...
										    <form class="form-horizontal progress_report_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_progress_report">
												...
												<div class="box yellow-border">
													...
													<div class="box-area pad-5 clearfix">
														...
														<div class="clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('progress_report_categories') ?? 'has-error';  ?>">
...
<p class="h4" style="font-size: 16px;"><strong>Archive Reminder Settings</strong>  <em class="fa fa-info-circle tooltip-enabled" title="" data-html="true" data-placement="top" data-original-title="Weekend days is excluded for the email sendout."></em></p>
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/archive_documents_settings">
									...
									<div class=" clearfix m-top-10 m-bottom-10">
										<div class="input-group">
											<span class="input-group-addon" required id=""><i class="fa fa-calendar"></i> Reminder Starts Before Expiry </span>
									...
									<div class=" clearfix m-top-10 m-bottom-10"> 
										<div class="input-group">
											<span class="input-group-addon" required id=""><i class="fa fa-calendar"></i> Day Reminder </span>
									...
									<div class="input-group  m-bottom-10 "> 
										...
										<select class="form-control" required name="remind_emp_on_expire" id="remind_emp_on_expire">						
							...
							<div class="col-md-6 col-xs-12 clearfix pad-10">
								...
								<form method="post" autocomplete="off" action="<?php echo current_url(); ?>/set_assignmnt_doc_type">
									...
									<div class="input-group m-bottom-10">
										...
										<select class="form-control" required name="doc_type_name">
											<option disabled selected value="" class="hide">Select Document Type</option>
									...
									<div class="input-group  m-bottom-10 "> 
										...
										<select class="form-control" required name="emp_name" id="assgn_emp_name">
									...
									<div class=" clearfix m-top-10 m-bottom-10"> 
										<div class="input-group">
											...
											<input type="text" placeholder="DD/MM/YYYY" required class="form-control datepicker" data-date-format="dd/mm/yyyy" id="date_expiry_arhdoc" name="date_expiry_arhdoc" value="" style="z-index:0 !important;"  autocomplete="off">
							...
							<div class="col-xs-12 col-md-6 clearfix pad-10">
								...
								<form method="post" action="<?php echo base_url(); ?>/admin/update_emp_supply_remnd">
									<div class="input-group m-bottom-10">
										...
										<select class="form-control" required id="remind_emp_csup_user" name="remind_emp_csup_user"  tabindex="-1">
									...
									<div class="input-group m-bottom-10">
										...
										<input type="number" step="1" min="1" required placeholder="Number of Days" name="days_lead_reminder" autocomplete="off" class="form-control" value="<?php echo $wa_emp_assnmt['reminder_lead_days']; ?>"> 
								...
								<form method="post" action="<?php echo base_url(); ?>/admin/update_emp_supply_remnd">
									...
									<div class="input-group m-bottom-10">
										...
										<input type="number" step="1" min="1" required  placeholder="Number of Days" name="days_lead_reminder" autocomplete="off" class="form-control" value="<?php echo $nsw_emp_assnmt['reminder_lead_days']; ?>"> 
										<span class="input-group-addon">Default <?php echo $static_defaults[0]->client_supply_reminder_dys; ?> Days</span> 
									</div>
							...
							<div class="col-xs-12 col-md-6 clearfix pad-10">
								...
								<form method="post" action="<?php echo base_url(); ?>/admin/update_lead_days">
									<div class="input-group m-bottom-10">
										...
										<input type="number" step="1" min="1" required  class="form-control" placeholder="Number of Lead Days" name="days" autocomplete="off" value="<?php echo $static_defaults[0]->client_supply_reminder_dys; ?>" > 
								...
								<form method="post" action="<?php echo base_url(); ?>/admin/update_weeks_delivery">
									<div class="input-group m-bottom-10">
										...
										<input type="number" step="1" min="1" required  class="form-control" placeholder="Number of Lead Days" name="weeks" autocomplete="off" value="<?php echo $static_defaults[0]->weeks_delivery; ?>" > 
								...
								<form method="post" action="<?php echo base_url(); ?>/admin/set_company_warehouse">
									<div class="input-group m-bottom-10">
										...
										<select class="form-control" required  id="company_brand_name" name="company_brand_name"  tabindex="-1">
											<option value="" disabled="" class="hide" selected="1"> Select</option>							
									...
									<div class="input-group m-bottom-10">
										...
										<select class="form-control" id="warehouse_location" required name="warehouse_location"  tabindex="-1">
											<option value="0" disabled="" class="hide" selected > Select</option>
	...
	<div class="box yellow-border m-top-10 contractor_feedback_settings" id="">
		...
		<div class="box-area clearfix ">
			<div class="col-xs-12 col-md-6 clearfix pad-10">
				...
				<?php if(@$this->session->getFlashdata('feeback_deleted')): ?>
					<div class="no-pad-t">
				...
				<?php else: ?>
					...
					<form method="post" action="<?php echo base_url(); ?>/admin/add_feedback">
						<div class="input-group m-bottom-10">
							<span class="input-group-addon">Start Range</span>
							<input name="start_range" min="0" max="100" step="any" required type="number" onclick="this.select()" autocomplete="off" value="0.00" placeholder="0.00" class="form-control">
							<span class="input-group-addon">%</span>
						</div>

						<div class="input-group m-bottom-10">
							<span class="input-group-addon">End Range</span>
							<input name="end_rage" min="1" max="100" step="any" required type="number" onclick="this.select()" autocomplete="off" value="0.00" placeholder="0.00" class="form-control">
							<span class="input-group-addon">%</span>
						</div>

						<div class="input-group m-bottom-10">
							<span class="input-group-addon"><i class="fa fa-envelop"></i> Details</span>
							<input type="text" placeholder="Details" required name="feedback_statement" autocomplete="off" value="" class="form-control">
							<span class="input-group-btn"><input type="submit" value="Save" class="btn btn-primary"></span>
						</div>
					</form>
...
<p class="h4 pad-right-10 pad-left-10" style="font-size: 16px;"><strong>Email Feedbacks - Accepted Project</strong></p>
<hr style="margin: 5px 10px 0px;">
...
<p class="h4 pad-right-10 pad-left-10" style="font-size: 16px;"><strong>Email Feedbacks - Unaccepted Project</strong></p>
<hr style="margin: 5px 10px 0px;">
			...
			<div class="col-xs-12 col-md-6 clearfix pad-10">
				<form method="post" autocomplete="off" action="<?php echo current_url(); ?>/update_fbck_unaccepted_s_email">
					<p class="h4" style="font-size: 16px;">
						<strong><i class="fa fa-envelope-o" aria-hidden="true"></i> Un-accepted Project - Successful Contactor</strong>
						<button type="submit" class="btn btn-xs btn-warning pull-right"><i class="fa fa-floppy-o"></i> Update</button>
					</p>
					<hr style="margin: 0px; padding: 3px 0px 5px;">
					<textarea id="unaccepted_selected_email" name="unaccepted_selected_email" class="form-control" style="height: 250px;"><?php echo  $static_defaults[0]->unaccepted_selected_email; ?></textarea>
				</form>
			</div>
			...
			<div class="col-xs-12 col-md-6 clearfix pad-10">
				<form method="post" autocomplete="off" action="<?php echo current_url(); ?>/update_fbck_unaccepted_us_email">
					<p class="h4" style="font-size: 16px;">
						<strong><i class="fa fa-envelope-o" aria-hidden="true"></i> Un-accepted Project - Unsuccessful Contactor</strong>
						<button type="submit" class="btn btn-xs btn-warning pull-right"><i class="fa fa-floppy-o"></i> Update</button>
					</p>
					<hr style="margin: 0px; padding: 3px 0px 5px;">
					<textarea id="unaccepted_unselected_email" name="unaccepted_unselected_email" class="form-control" style="height: 250px;"><?php echo  $static_defaults[0]->unaccepted_unselected_email; ?></textarea>
				</form>
			</div>
...
<!-- contractor_feedback here-->
								...
								<div class="box blue-border m-top-0 job_book_email_defaults" id="form_invoice_default_email">
									...
									<div class="box-area clearfix pad-10">
										...
										<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/invoice_email">
											...
											<?php if(@$this->session->getFlashdata('invoice_default_email')): ?>
												<div class="no-pad-t">
													<p class=""><br /></p>
													<p class=""><br /></p>
													<div class="border-less-box alert alert-success fade in pad-5 m-bottom-15">
														<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
														<?php echo $this->session->getflashdata('invoice_default_email');?>
													</div>
												</div>
											<?php endif; ?>
											...
											<div class="box yellow-border m-top-0">
												...
												<div class="box-area pad-5 clearfix">
													...
													<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('recipient_email') ?? 'has-error';  ?>">
														...
														<div class="col-sm-8">
															<div class="input-group">
																...
																<input type="email" required class="form-control" id="recipient_email" name="recipient_email" placeholder="Recipient Email" value="<?php echo $static_defaults[0]->invoice_to; ?>">
															</div>
														</div>
													</div>

													<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('optional_cc_email') ?? 'has-error';  ?>">
										...
										<form class="form-horizontal cpo_cqr_notes_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_notes">
											...
											<div class="box yellow-border">
												...
												<div class="box-area pad-5 clearfix">
													...
													<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('cqr_notes_w_ins') ?? 'has-error';  ?>">
														<label for="time-half" class="col-sm-4 control-label">CQR Notes with Insurance</label>
														<div class="col-sm-8">
															<textarea class="form-control" id="cqr_notes_w_ins" name="cqr_notes_w_ins" style = "height: 60px " maxlength="90"><?= $_POST['cqr_notes_w_ins'] ?? $cqr_notes_w_insurance; ?></textarea>
														</div>
													</div>

													<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('cqr_notes_no_ins') ?? 'has-error';  ?>">
														<label for="double-time" class="col-sm-4 control-label">CQR Notes No Insurance</label>
														<div class="col-sm-8">
															<textarea class="form-control" id="cqr_notes_no_ins" name="cqr_notes_no_ins" style = "height: 60px " maxlength="90"><?= $_POST['cqr_notes_no_ins'] ?? $cqr_notes_no_insurance; ?></textarea>
														</div>
													</div>

													<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('cpo_notes_w_ins') ?? 'has-error';  ?>">
														<label for="time-half" class="col-sm-4 control-label">CPO Notes with Insurance</label>
														<div class="col-sm-8">
															<textarea class="form-control" id="cpo_notes_w_ins" name="cpo_notes_w_ins" style = "height: 60px " maxlength="90"><?= $_POST['cpo_notes_w_ins'] ?? $cpo_notes_w_insurance; ?></textarea>
														</div>
													</div>

													<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('cpo_notes_no_ins') ?? 'has-error';  ?>">
														<label for="double-time" class="col-sm-4 control-label">CPO Notes No Insurance</label>
														<div class="col-sm-8">
															<textarea class="form-control" id="cpo_notes_no_ins" name="cpo_notes_no_ins" style = "height: 60px " maxlength="90"><?= $_POST['cpo_notes_no_ins'] ?? $cpo_notes_no_insurance; ?></textarea>
														</div>
													</div>
									    ...
									    <div class="box yellow-border cqr_email_template">
									    	...
									    	<div class="box-area pad-5 clearfix">
									    		<form role="form" method="post" action="<?php echo base_url() ?>/admin/update_cqr_template" class="form-horizontal clearfix form ">
									    			...
									    			<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_cqr') ?? 'has-error';  ?>">
									    				<div class=""><textarea class="form-control" required id="email_msg_cqr" name="email_msg_cqr" style="height: 130px "><?= $_POST['email_msg_cqr'] ?? $cqr_email_template; ?></textarea></div>
									    			</div>
									    			<div class="col-sm-4 col-xs-12 clearfix ">
										    			<div class="input-group m-bottom-10">
										    				<span class="input-group-addon"><i class="fa fa-clock"></i>Contractor Tender Due Time</span>

										    				<select class="form-control" required id="tender_due_time" name="tender_due_time" >
		...
		<div id="" class="">
			<?php foreach ($all_focus_company_banners as $key => $email_banners): ?>
				<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix ">
					...
					<a href="<?php echo base_url(); ?>/uploads/misc/<?php echo $email_banners->banner_name; ?>" target="_blank"><img width="100%"  src="<?php base_url(); ?>uploads/misc/<?php echo $email_banners->banner_name; ?>" /></a>
				</div>
			<?php endforeach; ?>
		</div>
	</div>
									    ...
									    <form class="form-horizontal joinery_primary_email_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_progress_report">
											...
											<div class="box yellow-border">
												...
												<div class="box-area pad-5 clearfix">
													...
													<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('progress_report_categories') ?? 'has-error';  ?>">
													...
													<div class="col-sm-offset-1 col-md-4 col-sm-4 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('progress_report_categories') ?? 'has-error';  ?>">
						...
						<div class="panel panel-primary">
					      	...
					      	<div class="panel-body">
						      	<div class="col-sm-8">
									...
									<?php //echo $_POST['user_id'] ?? null; ?>
									<script type="text/javascript">$('select#reviewer').val('<?php echo $induction_assigned_user; ?>');</script>
								</div>
						...
						<div class="panel panel-primary">
					      	...
					      	<div class="panel-body">
						      	<div class="col-sm-8">
									...
									<script type="text/javascript">$('select#accounts').val('<?php echo $induction_assigned_user; ?>');</script>
								</div>
...
<?php //review_code ?>
		...
		<form class="form-horizontal induction_health_and_safety_email_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_induction">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_induction') ?? 'has-error';  ?>">
						<label class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_induction" name="sender_name_induction" value = "<?= $_POST['sender_name_induction'] ?? $induction_sender_name; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_induction') ?? 'has-error';  ?>">
						<label class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_induction" name="sender_email_induction" value = "<?= $_POST['sender_email_induction'] ?? $induction_sender_email; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_induction') ?? 'has-error';  ?>">
						<label class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_induction" name="subject_induction" value = "<?= $_POST['subject_induction'] ?? $induction_subject; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_induction') ?? 'has-error';  ?>">
						<label class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_induction" name="bcc_email_induction" value = "<?= $_POST['bcc_email_induction'] ?? $induction_bcc_email; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('user_assigned_induction') ?? 'has-error';  ?>">
						<label class="col-sm-4 control-label">User Responsible: </label>
						<div class="col-sm-8">
							<select name="user_assigned_induction" class="form-control find_contact_person" id="user_assigned_induction" style="width: 100%;" tabindex="25">																			
								<?php $this->admin->fetch_users_list(); ?>														
							</select>
							<script type="text/javascript">setTimeout(function(){ $('select#user_assigned_induction').val('<?php echo $induction_assigned_user; ?>');  }, 1000); </script>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_induction') ?? 'has-error';  ?>">
						<label class="col-sm-2 control-label">New Message to Contactor for Induction:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_induction" name="email_msg_induction" style="height: 100px "><?= $_POST['email_msg_induction'] ?? $induction_message_content; ?></textarea>
						</div>
					</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_induction_update') ?? 'has-error';  ?>">
						<label class="col-sm-2 control-label">Will be send out automatically to contractor a year after it was entered:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_induction_update" name="email_msg_induction_update" style="height: 100px "><?= $_POST['email_msg_induction_update'] ?? $induction_message_content_update; ?></textarea>
						</div>
					</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_induction_video') ?? 'has-error';  ?>">
						<label class="col-sm-2 control-label">Message to Site Staff for Site Specific Induction:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_induction_video" name="email_msg_induction_video" style="height: 100px "><?= $_POST['email_msg_induction_video'] ?? $induction_message_content_video; ?></textarea>
						</div>
					</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_induction_video_fss') ?? 'has-error';  ?>">
						<label class="col-sm-2 control-label">Message to Site Staff for Site Specific Induction:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_induction_video_fss" name="email_msg_induction_video_fss" style="height: 100px "><?= $_POST['email_msg_induction_video_fss'] ?? $induction_message_content_video_fss; ?></textarea>
						</div>
					</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_induction_video_oss') ?? 'has-error';  ?>">
						<label class="col-sm-2 control-label">Message to Site Staff for Site Specific Induction:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_induction_video_oss" name="email_msg_induction_video_oss" style="height: 100px "><?= $_POST['email_msg_induction_video_oss'] ?? $induction_message_content_video_oss; ?></textarea>
						</div>
					</div>
		...
		<form class="form-horizontal insurance_email_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_no_insurance') ?? 'has-error';  ?> ">
						<label for="" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_no_insurance" name="sender_name_no_insurance" value = "<?= $_POST['XXXXXXX'] ?? $sender_name; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_no_insurnace') ?? 'has-error';  ?> ">
						<label for="" class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_no_insurnace" name="sender_email_no_insurnace" value = "<?= $_POST['XXXXXXX'] ?? $sender_email; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_no_insurnace') ?? 'has-error';  ?> ">
						<label for="" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_no_insurnace" name="subject_no_insurnace" value = "<?= $_POST['XXXXXXX'] ?? $subject; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_no_insurnace') ?? 'has-error';  ?> ">
						<label for="" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_no_insurnace" name="bcc_email_no_insurnace" value = "<?= $_POST['XXXXXXX'] ?? $bcc_email; ?>">
						</div>
					</div>


					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('user_assigned_forinsurance') ?? 'has-error';  ?> ">
						<label for="" class="col-sm-4 control-label">User Responsible: </label>
						<div class="col-sm-8">
							<select name="user_assigned_forinsurance" class="form-control find_contact_person" id="user_assigned_forinsurance" style="width: 100%;" tabindex="25">																											
								<?php $this->admin->fetch_users_list(); ?>														
							</select>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_no_insurance') ?? 'has-error';  ?> ">
						<label for="" class="col-sm-2 control-label">Message to Contractor for Expires or <br>no Insurance:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_no_insurance" name="email_msg_no_insurance" style="height: 100px "><?= $_POST['email_msg_no_insurance'] ?? $message_content; ?></textarea>
						</div>
					</div>
...
<div class="box blue-border m-top-0">
	...
	<?php if(@$this->session->getflashdata('onboarding_default_email')): ?>
		<div class="no-pad-t">
			<div class="border-less-box alert alert-success fade in pad-5 m-bottom-15 m-5">
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>				
				<?php echo $this->session->getflashdata('onboarding_default_email');?>
			</div>
		</div>
	<?php endif; ?>
	...
	<div class="box-area clearfix pad-10">
		...
		<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding_clients">
			...
			<div class="box yellow-border onboarding_sending_link_email_defaults">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding_clients') ?? 'has-error';  ?>">
						<label for="sender_name_onboarding_clients" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding_clients" name="sender_name_onboarding_clients" value = "<?= $_POST['sender_name_onboarding_clients'] ?? $onboarding_sender_name_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding_clients') ?? 'has-error';  ?>">
						<label for="sender_email_onboarding_clients" class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding_clients" name="sender_email_onboarding_clients" value = "<?= $_POST['sender_email_onboarding_clients'] ?? $onboarding_sender_email_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding_clients') ?? 'has-error';  ?>">
						<label for="subject_onboarding_clients" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding_clients" name="subject_onboarding_clients" value = "<?= $_POST['subject_onboarding_clients'] ?? $onboarding_subject_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding_clients') ?? 'has-error';  ?>">
						<label for="bcc_email_onboarding_clients" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding_clients" name="bcc_email_onboarding_clients" value = "<?= $_POST['bcc_email_onboarding_clients'] ?? $onboarding_bcc_email_clients; ?>">
						</div>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_clients') ?? 'has-error';  ?>">
						<label for="email_msg_onboarding_clients" class="col-sm-2 control-label">Message to Contractor for Company Details:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding_clients" name="email_msg_onboarding_clients" style="height: 100px "><?= $_POST['email_msg_onboarding_clients_clients'] ?? $onboarding_message_content_clients; ?></textarea>
						</div>
					</div>
		...
		<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding') ?? 'has-error';  ?>">
						<label for="sender_name_onboarding" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding" name="sender_name_onboarding" value = "<?= $_POST['sender_name_onboarding'] ?? $onboarding_sender_name; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding') ?? 'has-error';  ?>">
						<label for="sender_email_onboarding" class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding" name="sender_email_onboarding" value = "<?= $_POST['sender_email_onboarding'] ?? $onboarding_sender_email; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding') ?? 'has-error';  ?>">
						<label for="subject_onboarding" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding" name="subject_onboarding" value = "<?= $_POST['subject_onboarding'] ?? $onboarding_subject; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding') ?? 'has-error';  ?>">
						<label for="bcc_email_onboarding" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding" name="bcc_email_onboarding" value = "<?= $_POST['bcc_email_onboarding'] ?? $onboarding_bcc_email; ?>">
						</div>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding') ?? 'has-error';  ?>">
						<label for="email_msg_onboarding" class="col-sm-2 control-label">Message to Contractor for Company Details:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding" name="email_msg_onboarding" style="height: 100px "><?= $_POST['email_msg_onboarding'] ?? $onboarding_message_content; ?></textarea>
						</div>
					</div>
	    ...
	    <form class="form-horizontal onboarding_bank_details_form" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding_bank">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding_bank') ?? 'has-error';  ?>">
						<label for="sender_name_onboarding_bank" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding_bank" name="sender_name_onboarding_bank"  value="<?= $_POST['sender_name_onboarding_bank'] ?? $onboarding_sender_name_bank; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding_bank') ?? 'has-error';  ?>">
						<label for="sender_email_onboarding_bank" class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding_bank" name="sender_email_onboarding_bank"  value="<?= $_POST['sender_email_onboarding_bank'] ?? $onboarding_sender_email_bank; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding_bank') ?? 'has-error';  ?>">
						<label for="subject_onboarding_bank" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding_bank" name="subject_onboarding_bank"  value="<?= $_POST['subject_onboarding_bank'] ?? $onboarding_subject_bank; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding_bank') ?? 'has-error';  ?>">
						<label for="bcc_email_onboarding_bank" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding_bank" name="bcc_email_onboarding_bank"  value="<?= $_POST['bcc_email_onboarding_bank'] ?? $onboarding_bcc_email_bank; ?>"  >
						</div>
					</div>
					
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_bank') ?? 'has-error';  ?>">
						<label for="email_msg_onboarding_bank" class="col-sm-2 control-label">Message to Contractor for Bank Details:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding_bank" name="email_msg_onboarding_bank" style="height: 100px "><?= $_POST['email_msg_onboarding_bank'] ?? $onboarding_message_content_bank; ?></textarea>
						</div>
					</div>
		...
		<div class="box yellow-border">
			...
			<div class="box-area pad-5 clearfix">
				...
				<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_bank_form1') ?? 'has-error';  ?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_bank_form2') ?? 'has-error';  ?> ">
	    ...
	    <form class="form-horizontal onboarding_message_for_contractors_only" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_contractor_msg">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_contractor_msg')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?php echo $this->session->getflashdata('onboarding_contractor_msg');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_contractor_msg') ?? 'has-error';  ?>">
	    ...
	    <form class="form-horizontal onboarding_email_notification" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_email">
			...
			<div class="box yellow-border m-top-0">
				...
				<div class="box-area pad-5 clearfix">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_recipient_email') ?? 'has-error';  ?>">
						<label for="onboarding_recipient_email" class="col-sm-4 control-label">Onboarding Recipient Email</label>
						<div class="col-sm-8">
							<div class="input-group">
								<span class="input-group-addon" id=""><i class="fa fa-envelope-o"></i></span>
								<input type="email" required class="form-control" id="onboarding_recipient_email" name="onboarding_recipient_email" placeholder="Recipient Email" value="<?php echo $static_defaults[0]->onboarding_to; ?>">
							</div>
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_optional_cc_email') ?? 'has-error';  ?>">
						<label for="onboarding_optional_cc_email" class="col-sm-4 control-label">Onboarding Optional CC Email</label>
						<div class="col-sm-8">
							<div class="input-group">
								<span class="input-group-addon" id=""><i class="fa fa-envelope-o"></i></span>
								<input type="email" required class="form-control" id="onboarding_optional_cc_email" name="onboarding_optional_cc_email" placeholder="Optional CC Email" value="<?php echo $static_defaults[0]->onboarding_cc; ?>">
							</div>
						</div>
					</div>
	    ...
	    <form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding_notif">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding_notif') ?? 'has-error';  ?>">
						<label for="sender_name_onboarding_notif" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding_notif" name="sender_name_onboarding_notif" value = "<?= $_POST['sender_name_onboarding_notif'] ?? $onboarding_notif_sender_name; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding_notif') ?? 'has-error';  ?>">
						<label for="sender_email_onboarding_notif" class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding_notif" name="sender_email_onboarding_notif" value = "<?= $_POST['sender_email_onboarding_notif'] ?? $onboarding_notif_sender_email; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding_notif') ?? 'has-error';  ?>">
						<label for="subject_onboarding_notif" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding_notif" name="subject_onboarding_notif" value = "<?= $_POST['subject_onboarding_notif'] ?? $onboarding_notif_subject; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding_notif') ?? 'has-error';  ?>">
						<label for="bcc_email_onboarding_notif" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding_notif" name="bcc_email_onboarding_notif" value = "<?= $_POST['bcc_email_onboarding_notif'] ?? $onboarding_notif_bcc_email; ?>">
						</div>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_notif') ?? 'has-error';  ?>">
						<label for="email_msg_onboarding_notif" class="col-sm-2 control-label">Message to Contractor for Company Details:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding_notif" name="email_msg_onboarding_notif" style="height: 100px "><?= $_POST['email_msg_onboarding_notif'] ?? $onboarding_notif_message_content; ?></textarea>
						</div>
					</div>
	    ...
	    <form class="form-horizontal onboarding_approved_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding_approved_clients">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding_approved_clients') ?? 'has-error';  ?>">
						<label for="sender_name_onboarding_approved_clients" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding_approved_clients" name="sender_name_onboarding_approved_clients" value = "<?= $_POST['sender_name_onboarding_approved_clients'] ?? $onboarding_approved_sender_name_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding_approved_clients') ?? 'has-error';  ?>">
						<label for="sender_email_onboarding_approved_clients" class="col-sm-4 control-label">Default Senders Email:</label>
							<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding_approved_clients" name="sender_email_onboarding_approved_clients" value = "<?= $_POST['sender_email_onboarding_approved_clients'] ?? $onboarding_approved_sender_email_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding_approved_clients') ?? 'has-error';  ?>">
						<label for="subject_onboarding_approved_clients" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding_approved_clients" name="subject_onboarding_approved_clients" value = "<?= $_POST['subject_onboarding_approved_clients'] ?? $onboarding_approved_subject_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding_approved_clients') ?? 'has-error';  ?>">
						<label for="bcc_email_onboarding_approved_clients" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding_approved_clients" name="bcc_email_onboarding_approved_clients" value = "<?= $_POST['bcc_email_onboarding_approved_clients'] ?? $onboarding_approved_bcc_email_clients; ?>">
						</div>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_approved_clients') ?? 'has-error';  ?>">
						...
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding_approved_clients" name="email_msg_onboarding_approved_clients" style="height: 100px "><?= $_POST['email_msg_onboarding_approved_clients'] ?? $onboarding_approved_message_content_clients; ?></textarea>
						</div>
					</div>
	    ...
	    <form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding_approved">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding_approved') ?? 'has-error';  ?>">
						<label for="sender_name_onboarding_approved" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding_approved" name="sender_name_onboarding_approved" value = "<?= $_POST['sender_name_onboarding_approved'] ?? $onboarding_approved_sender_name; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding_approved') ?? 'has-error';  ?>">
						<label for="sender_email_onboarding_approved" class="col-sm-4 control-label">Default Senders Email:</label>
							<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding_approved" name="sender_email_onboarding_approved" value = "<?= $_POST['sender_email_onboarding_approved'] ?? $onboarding_approved_sender_email; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding_approved') ?? 'has-error';  ?>">
						<label for="subject_onboarding_approved" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding_approved" name="subject_onboarding_approved" value = "<?= $_POST['subject_onboarding_approved'] ?? $onboarding_approved_subject; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding_approved') ?? 'has-error';  ?>">
						<label for="bcc_email_onboarding_approved" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding_approved" name="bcc_email_onboarding_approved" value = "<?= $_POST['bcc_email_onboarding_approved'] ?? $onboarding_approved_bcc_email; ?>">
						</div>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_approved') ?? 'has-error';  ?>">
						<label for="email_msg_onboarding_approved" class="col-sm-2 control-label">Message to Contractor for Company Details:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding_approved" name="email_msg_onboarding_approved" style="height: 100px "><?= $_POST['email_msg_onboarding_approved'] ?? $onboarding_approved_message_content; ?></textarea>
						</div>
					</div>
	    ...
	    <form class="form-horizontal onboarding_declined_defaults" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding_declined_clients">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding_declined_clients') ?? 'has-error';  ?>">
						<label for="sender_name_onboarding_declined_clients" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding_declined_clients" name="sender_name_onboarding_declined_clients" value = "<?= $_POST['sender_name_onboarding_declined_clients'] ?? $onboarding_declined_sender_name_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding_declined_clients') ?? 'has-error';  ?>">
						<label for="sender_email_onboarding_declined_clients" class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding_declined_clients" name="sender_email_onboarding_declined_clients" value = "<?= $_POST['sender_email_onboarding_declined_clients'] ?? $onboarding_declined_sender_email_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding_declined_clients') ?? 'has-error';  ?>">
						<label for="subject_onboarding_declined_clients" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding_declined_clients" name="subject_onboarding_declined_clients" value = "<?= $_POST['subject_onboarding_declined_clients'] ?? $onboarding_declined_subject_clients; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding_declined_clients') ?? 'has-error';  ?>">
						<label for="bcc_email_onboarding_declined_clients" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding_declined_clients" name="bcc_email_onboarding_declined_clients" value = "<?= $_POST['bcc_email_onboarding_declined_clients'] ?? $onboarding_declined_bcc_email_clients; ?>">
						</div>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_declined_clients') ?? 'has-error';  ?>">
						...
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding_declined_clients" name="email_msg_onboarding_declined_clients" style="height: 100px "><?= $_POST['email_msg_onboarding_declined_clients'] ?? $onboarding_declined_message_content_clients; ?></textarea>
						</div>
					</div>
	    ...
	    <form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/default_email_message_onboarding_declined">
			...
			<div class="box yellow-border">
				...
				<div class="box-area pad-5 clearfix">
					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_name_onboarding_declined') ?? 'has-error';  ?> ">
						<label for="sender_name_onboarding_declined" class="col-sm-4 control-label">Default Sender Name:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_name_onboarding_declined" name="sender_name_onboarding_declined" value = "<?= $_POST['sender_name_onboarding_declined'] ?? $onboarding_declined_sender_name; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('sender_email_onboarding_declined') ?? 'has-error';  ?> ">
						<label for="sender_email_onboarding_declined" class="col-sm-4 control-label">Default Senders Email:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="sender_email_onboarding_declined" name="sender_email_onboarding_declined" value = "<?= $_POST['sender_email_onboarding_declined'] ?? $onboarding_declined_sender_email; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('subject_onboarding_declined') ?? 'has-error';  ?> ">
						<label for="subject_onboarding_declined" class="col-sm-4 control-label">Subject:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="subject_onboarding_declined" name="subject_onboarding_declined" value = "<?= $_POST['subject_onboarding_declined'] ?? $onboarding_declined_subject; ?>">
						</div>
					</div>

					<div class="col-md-6 col-sm-6 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('bcc_email_onboarding_declined') ?? 'has-error';  ?> ">
						<label for="bcc_email_onboarding_declined" class="col-sm-4 control-label">BCC:</label>
						<div class="col-sm-8">
							<input type = "text" class="form-control" id="bcc_email_onboarding_declined" name="bcc_email_onboarding_declined" value = "<?= $_POST['bcc_email_onboarding_declined'] ?? $onboarding_declined_bcc_email; ?>">
						</div>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('email_msg_onboarding_declined') ?? 'has-error';  ?> ">
						<label for="email_msg_onboarding_declined" class="col-sm-2 control-label">Message to Contractor for Company Details:</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="email_msg_onboarding_declined" name="email_msg_onboarding_declined" style="height: 100px "><?= $_POST['email_msg_onboarding_declined'] ?? $onboarding_declined_message_content; ?></textarea>
						</div>
					</div>
	    ...
	    <form class="form-horizontal onboarding_general_message_box" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_general_msg">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_general_msg')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>

							<?php echo $this->session->getflashdata('onboarding_general_msg');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_general_msg') ?? 'has-error';  ?>">
		...
		<form class="form-horizontal workplace_health_safety" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_workplace_health_safety">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_workplace_health_safety')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?php echo $this->session->getflashdata('onboarding_workplace_health_safety');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_workplace_health_safety') ?? 'has-error';  ?>">
		...
		<form class="form-horizontal safe_work_method_statements" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_swms">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_swms')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?php echo $this->session->getflashdata('onboarding_swms');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_swms') ?? 'has-error';  ?>">
		...
		<form class="form-horizontal job_safety_analysis" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_jsa">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_jsa')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?php echo $this->session->getflashdata('onboarding_jsa');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix   <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_jsa') ?? 'has-error';  ?>">
		...
		<form class="form-horizontal reviewed_swms" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_reviewed_swms">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_reviewed_swms')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?php echo $this->session->getflashdata('onboarding_reviewed_swms');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix   <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_reviewed_swms') ?? 'has-error';  ?>">
		...
		<form class="form-horizontal safety_related_convictions" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_safety_related_convictions">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_safety_related_convictions')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?php echo $this->session->getflashdata('onboarding_safety_related_convictions');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix   <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_safety_related_convictions') ?? 'has-error';  ?>">
		...
		<form class="form-horizontal confirm_licences_certifications" role="form" method="post" action="<?php echo current_url(); ?>/onboarding_confirm_licences_certifications">
			...
			<div class="box yellow-border">
				...
				<?php if(@$this->session->getflashdata('onboarding_confirm_licences_certifications')): ?>
					<div class="no-pad-t">
						<div class="border-less-box alert alert-success fade in pad-5 m-10">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<?php echo $this->session->getflashdata('onboarding_confirm_licences_certifications');?>
						</div>
					</div>
				<?php endif; ?>

				<div class="box-area pad-5 clearfix">
					<div class="col-md-12 col-sm-12 col-xs-12 m-bottom-10 clearfix  <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('onboarding_confirm_licences_certifications') ?? 'has-error';  ?>">
...
<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/user_settings">
			...
			<div class="box-area clearfix pad-10">
				...
				<?php if(@$this->session->getflashdata('update_user_settings')): ?>
					<div class="col-sm-12 ">							
						<div class="no-pad-t">
							<div class="border-less-box alert alert-success fade in pad-5 m-top-5">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<?php echo $this->session->getflashdata('update_user_settings');?>
							</div>
						</div>
					</div>
				<?php endif; ?>
	...
	<p><hr /></p>
		...
		<?php if(@$this->session->getflashdata('leave_approval_notice')): ?>
			<div class="col-sm-12 ">							
				<div class="no-pad-t">
					<div class="border-less-box alert alert-success fade in m-top-5">
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
						<?php echo $this->session->getflashdata('leave_approval_notice'); ?>
					</div>
				</div>
			</div>
		<?php endif; ?>
		...
		<div class="box blue-border m-top-0">
			...
			<div class="box-area clearfix pad-10 leave_rates">
				...
				<div class="box yellow-border m-top-0">
					...
					<?php if(@$this->session->getflashdata('update_user_settings_leave_rates')): ?>
						<div class="col-sm-12 ">							
							<div class="no-pad-t">
								<div class="border-less-box alert alert-success fade in m-top-5 pad-5">
									<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
									<?php echo $this->session->getflashdata('update_user_settings_leave_rates');?>
								</div>
							</div>
						</div>
					<?php endif; ?>
							...
							<div class="col-sm-12 col-md-6 pad-15">
								...
								<form id="frmSalariedRates" class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/salaried_rates">
									...
									<div class="m-bottom-10">
										<div class="input-group">
											...
											<input type="number" step="any" min="1" required class="form-control text-center" value="<?php echo $select_leave_rates_salaried[0]->annual_leave; ?>" name="salaried_total_annual_leave" id="salaried_total_annual_leave">
									...
									<div class="m-bottom-10">
										<div class="input-group">
											...
											<input type="number" step="any" min="1" required class="form-control text-center" value="<?php echo $select_leave_rates_salaried[0]->personal_leave; ?>" name="salaried_total_personal_leave" id="salaried_total_personal_leave">
								...
								<form class="form-horizontal" id="frmWagesRates" role="form" method="post" action="<?php echo current_url(); ?>/wages_rates">
									...
									<div class="m-bottom-10">
										<div class="input-group">
											<span class="input-group-addon" id="">Total Annual Leave &nbsp; </span>	
											<input type="number" step="any" min="1" required class="form-control text-center" value="<?php echo $select_leave_rates_wages[0]->annual_leave; ?>" name="wages_total_annual_leave" id="wages_total_annual_leave">
									...
									<div class="m-bottom-10">
										<div class="input-group">
											<span class="input-group-addon" id="">Total Personal Leave</span>	
											<input type="number" step="any" min="1" required class="form-control text-center" value="<?php echo $select_leave_rates_wages[0]->personal_leave; ?>" name="wages_total_personal_leave" id="wages_total_personal_leave">
								...
								<p id="" class="m-bottom-10 ">&nbsp;</p>
									...
									<div class="m-bottom-10">
										<div class="input-group">
											...
											<input type="number" step="any" min="1" required class="form-control text-center" value="<?php echo $select_leave_rates_manila[0]->annual_leave; ?>" name="manila_total_vacation_leave" id="manila_total_vacation_leave">
									...
									<div class="m-bottom-10">
										<div class="input-group">
											...
											<input type="number" step="any" min="1" required class="form-control text-center" value="<?php echo $select_leave_rates_manila[0]->personal_leave; ?>" name="manila_total_sick_leave" id="manila_total_sick_leave">
					...
					<form class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>/update_leave_notice">
						...
						<div class="box-area clearfix pad-5">
							...
							<div class="col-md-3 col-sm-6 col-xs-12 clearfix m-top-10 m-bottom-10">
								<div class="input-group">
									<span class="input-group-addon" id=""><i class="fa fa-calendar"></i></span>
									<input type="number" step="any" min="1" required class="form-control" value="<?php echo $row1->days_advance_notice; ?>" name="annual_leave_notice<?php echo $i; ?>" id="annual_leave_notice<?php echo $i; ?>">
									<span class="input-group-addon" id="">Days</span>
								</div>			
							</div>
							<?php 
				...
				<div class="box yellow-border m-top-20">
					...
					<form class="form-horizontal leave_email_defaults" role="form" method="post" action="<?php echo current_url(); ?>/update_leave_emails">
						...
						<?php if(@$this->session->getflashdata('leave_approval_email')): ?>
							<div class="no-pad-t">
								<div class="border-less-box alert alert-success fade in pad-5 m-left-10 m-right-10">
									<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
									<?php echo $this->session->getflashdata('leave_approval_email');?>
								</div>
							</div>
						<?php endif; ?>
						...
						<div class="box-area pad-5 clearfix">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 m-top-10 m-bottom-10 clearfix  <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('leave_recipient_email') ?? 'has-error';  ?>">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 m-top-10 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('leave_cc_email') ?? 'has-error';  ?>   ">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 m-top-10 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('leave_bcc_email') ?? 'has-error';  ?>   ">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 m-top-10 m-bottom-10 clearfix <?= $_SERVER['REQUEST_METHOD'] === 'POST' && $validation->getError('leave_message_content') ?? 'has-error';  ?>  ">
								<label for="leave_message_content" class="col-sm-2 control-label">Message Content</label>
								<div class="clearfix ">
									<div class="col-sm-10">
										<textarea class="form-control" id="leave_message_content" name="leave_message_content" style="height: 100px "><?= $_POST['leave_message_content'] ?? $leave_email_defaults[0]->message; ?></textarea>												
									</div>
								</div>
							</div>
...
<!-- Site labour User Settings -->	
		...
		<script>
			...
			$("#add_rate_set").click(function(){
				...
				if(rate_set_name == ""){
				    ...
				    function(result){
				    	window.location  = baseurl+'admin?scroll=employee_rate_set_setting';
				    });
				}
			});
			...
			$("#add_rate_assignment").click(function(){
				...
				function(result){
				    ...
				    window.open(baseurl+'admin?scroll=employee_rate_setting', '_self', true);
				});
			});
		...
		<div class="box blue-border m-top-0 employee_location">
			...
			<div class="box-area clearfix pad-5">
					...
					<?php if(@$this->session->getflashdata('delete_location_assign')): ?>
						<div class="m-top-5">							
							<div class="no-pad-t">
								<div class="border-less-box alert alert-success fade in pad-5">
									<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
									<?php echo $this->session->getflashdata('delete_location_assign');?>
								</div>
							</div>
						</div>
					<?php endif; ?>
					...
					<?php if(@$this->session->getflashdata('user_location_assign')): ?>
						<div class="m-top-5">							
							<div class="no-pad-t">
								<div class="border-less-box alert alert-success fade in pad-5">
									<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
									<?php echo $this->session->getflashdata('user_location_assign');?>
								</div>
							</div>
						</div>
					<?php endif; ?>
				...
				<div class="col-md-4 col-sm-6 col-xs-12 clearfix m-bottom-10">
					...
					<?php if(@$this->session->getflashdata('update_user_location')): ?>
						<div class="m-top-5">							
							<div class="no-pad-t">
								<div class="border-less-box alert alert-success fade in pad-5">
									<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
									<?php echo $this->session->getflashdata('update_user_location');?>
								</div>
							</div>
						</div>
					<?php endif; ?>
...
<div class="season_backgrounds">
	...
	<?php echo $this->admin->get_seasons(); ?>
					...
					<div id="" class="offset_on_sm2mid " style="height:100%;">
						<div id="" class="admin_side_nav_menu" style="background: #0E283C; padding: 10px; color: #fff; height:100%; overflow-y: hidden;">
							<p id="" class="  ">
...
function setModalBG(img_id_sesason){

 
	//alert('etst');

	var img_id_sesason_label = $('img#'+img_id_sesason).attr('alt');
	var bg_design_view_img = $('img#'+img_id_sesason).attr('src');

 
	$('img#bg_design_view_img').attr('src', bg_design_view_img);
	$('a#use_background_view_img').attr('href', '<?php echo base_url(); ?>/admin/set_background/'+img_id_sesason);
		  	...
		  	<div class="modal-dialog  " style = "width:700px">
		    	...
		    	<div class="modal-content">
		      		...
		      		<div class="modal-body pad-10">	
		      			...
		      			<form method="post" action="<?php echo base_url(); ?>/admin/update_arc_doc_type" id="update_arc_doc_type">
		      				<div class="input-group m-bottom-15">
