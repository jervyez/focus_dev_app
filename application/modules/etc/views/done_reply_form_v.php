...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Quote Form Successful">
  ...
  <body class="bg-light">
    <div class="container">
      <div class="py-3 text-center">
        ...
        <h2>Your quote submission has been received.</h2>
        <p class="lead">You successfully submitted your quote, we will verify and evaluate your data.</p>
        <hr />
      </div>
