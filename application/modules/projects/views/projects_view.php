...
<div class="input-group-btn">  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> &nbsp; <span class="caret"></span>&nbsp; 
...
$("#gen_blue_book").click(function(){
	...
	if(no_induction == 0){
	    ...
	    function(result){
		    ...
		    function(result){
	     		window.open("<?php echo base_url() ?>projects/generate_bluebook/<?php echo $project_id ?>");
	     	});
	    });
	}else{
		$.post(baseurl+"induction_health_safety/generate_site_diary_qrcode",
...
<div id="quote_review" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" style="display: none; overflow: hidden;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" action="<?php echo base_url(); ?>projects/set_quote_review" id="set_quote_review">
				<input type="hidden" name="project_id_review" value="<?php echo $project_id; ?>">
