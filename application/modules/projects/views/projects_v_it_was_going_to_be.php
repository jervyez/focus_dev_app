				...
				<div class="row">
                  ...
                  <?php if($this->session->userdata('is_admin') == 1): ?>
                   ...
                   <div id="" class="pull-right">
                     ...
                     <a href="<?php echo base_url(); ?>projects/view_all" class="btn btn-info pull-right pull-right m-left-10">View All Projects</a>
                          ...
                          echo '<option value="PM">Personal</option>';
							...
							<div class="box-area pad-10">
								<table id="projectTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									<tbody>
										<?php echo $this->projects->display_all_projects(550); ?>
									</tbody>
								</table>
							</div>
						</div>
              ...
              <div class="box-area pattern-sandstone pad-10">
                <div class="box-content box-list collapse in">
                 <ul id="list_removed_jobdate_prj" style="overflow-y: scroll;    height: 485px;">
                  <?php echo $this->projects->list_removed_jobdate_prj(30); ?>
                </ul>
              </div>
            </div>
          </div>
