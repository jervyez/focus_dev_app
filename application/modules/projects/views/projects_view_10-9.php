...
<div class="container-fluid">
															...
															<div class="box-area pad-5 text-center pad-bottom-10">
																...
																<div class="box-area m-top-15 clearfix quick_edit_project">
																	...
																	<div class="col-sm-12 m-bottom-10 clearfix">
																		...
																		<div class="col-sm-8  col-xs-12">
																			<input type="text" data-date-format="dd/mm/yyyy" placeholder="DD/MM/YYYY" title="" class="pad-10 tooltip-enabled form-control datepicker text-right" id="unaccepted_date" name="unaccepted_date" onblur = 'blur_unaccepted_date()' value="<?php echo $unaccepted_date; ?>">
																		</div>
																	</div>
																	<script>
 ...
 -->
																	...
																	<label for="site_start" class="col-sm-4 control-label m-top-5 text-left">Site Start</label>
																		<div class="col-sm-8  col-xs-12">
																			<input tabindex="6" type="text" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour sched, and will also change date range of of Project Schedule." placeholder="DD/MM/YYYY" class="tooltip-enabled quick_input form-control text-right" id="site_start" name="site_start" value="<?php echo $date_site_commencement; ?>">
																		</div>
																	</div>
																	...
																	<label for="site_finish" class="col-sm-4 control-label m-top-5 text-left">Site Finish</label>
																		<div class="col-sm-8  col-xs-12">
																			<input tabindex="7" type="text" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour sched, and will also change date range of of Project Schedule." placeholder="DD/MM/YYYY" class="tooltip-enabled quick_input form-control text-right" id="site_finish" name="site_finish" value="<?php echo $date_site_finish; ?>">
																		</div>
																	</div>
															...
															<div class="row">
																...
																<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 m-bottom-10 clearfix">
																	<div class="pad-15 no-pad-t">
																		...
																		<?php $shop_tenancy_numb = ($job_type != 'Shopping Center' ? '' : ''.$shopping_common_name.': '.$shop_tenancy_number.'<br />' ); ?>
																		...
																		<?php $ps_shop_tenancy_numb = ($job_type != 'Shopping Center' ? '' : ''.$shopping_common_name.': '.$shop_tenancy_number ); ?>
